...
public class EmployeeInfo extends Manager implements Employee{
	...
	final static String companyName = "SonS@Sons";
	int employeeId;
	String name;
	...
	public double calculateEmployeePension(){
		...
		System.out.println("Please enter start date in format ( Feb,2015): ");
		String joiningDate = sc.nextLine();
		System.out.println("Please enter today's date in format ( Nov,2017): ");
		String todaysDate = sc.nextLine();
		String convertedJoiningDate = DateConversion.convertDate(joiningDate);
		String convertedTodaysDate = DateConversion.convertDate(todaysDate);
		if (convertedJoiningDate.endsWith("2014") && convertedTodaysDate.endsWith("2017"))
		{total = ((int) (monthly * 0.13 * 12));
			System.out.println("Your pension is: (excluding salary) "+total);}
		else if (convertedJoiningDate.endsWith("2016") && convertedTodaysDate.endsWith("2017"))
	...
	public void AllDepartments() {
		System.out.println(" three Departments of this company are");
	}
